...
* **feature-awesomebar**
  * Providers implemented by this component now display website icons if a [BrowserIcons](https://mozac.org/api/mozilla.components.browser.icons/-browser-icons/) instance is provided.
