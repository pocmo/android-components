...
/**
 * Registers an [Observer] function that will be invoked whenever the state changes. The [BrowserStore.Subscription] will be
 ...
 */
fun BrowserStore.observe(view: View, observer: Observer, receiveInitialState: Boolean = true): BrowserStore.Subscription {
    return observe(receiveInitialState, observer).apply {
